...
| Criteria | Exemplary | Developing | No Marks |
|---|---|---|---|
| **Group Contribution** | Group completed at least 4 tasks for all 6 levels. All scripts were pushed to GitHub with the correct directory structure. (3 pts) | Group completed 4-5 levels with at least 4 tasks each, or the repository structure had minor naming errors. (1.5 pts) | 0 pts |
| **Peer Review** | Group successfully reviewed both assigned peer groups. Feedback provided was effective and addressed specific questions. (2 pts) | Group completed a review for only one assigned peer group. Feedback was general or lacked constructive detail. (1 pt) | 0 pts |
